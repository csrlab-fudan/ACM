...
%% quaternary GCM pair
[a, b] = gen_quaternary_gcm_pair(26, 15); 
figure;
stem3(xcorr2(a)+xcorr2(b));

%% binary GCM quad of size within 78x78
for i = 1:78
    for j = 1:78
        [q1, q2, q3, q4] = gen_binary_gcm_quad(i, j);
...
%% quaternary GCM quad of size 24 x n, n=1:1000
for i = 1:1000
    if i ~= 799 && i~=959
        [q1, q2, q3, q4] = gen_quaternary_gcm_quad(24, i);
        corr = abs(xcorr2(q1)+xcorr2(q2)+xcorr2(q3)+xcorr2(q4));
